...
function Main() {
  ...
  return (
    <div className="relative w-full h-screen">
      <div
        className="flex flex-col items-center justify-start w-full h-screen gap-1 bg-cover bg-center"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div  className=" container  bg-amber-50/80 flex  flex-row items-center justify-center gap-1 text-center">
          <div className="left w-[80%] h-screen flex flex-col items-center justify-center">
            <h1 className="text-6xl text-black flex items-center justify-center flex-wrap gap-1">
              Find Your Perfect <p className="text-orange-400 outlined-text ">Recipe!</p>{" "}
            </h1>
            <h2 className="text-2xl my-5">
              Search for delicious Recipe
              <p className="text-orange-400 inline text-outline 
 ">Z</p> and start cooking
              today!
            </h2>
